# [ita-webpack5-labs](https://github.com/rondinif/ita-webpack5-labs) > **lab-83-pug**: mix asset-management - fonts (lab-03) con gestione dell'output - HtmlWebpackPlugin + CleanWebpackPlugin (lab-08 ) + pug
